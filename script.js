...
//         const shadowColorOpasity = document.getElementById("shadow-color-opacity").value;
//         const shadowInset = document.getElementById("shadow-inset").checked;

//         let shadow = '';

//         if (shadowInset) shadow += 'inset';
//         shadow += `${hShadow}px ${vShadow}px ${blurRadius}px ${spreadRadius}px ${shadowColor}px ${ shadowColorOpasity}px ${hexToRGBA(shadowColor, shadowColorOpasity)}`
